<?php
    if(isset($_GET['page'])){
        $page = $_GET['page'];
        $data = file_get_contents('http://140.114.212.79/AdvancedWeb-AS3/pagination.php?page='.$page);
    }else{
        $data = file_get_contents('http://140.114.212.79/AdvancedWeb-AS3/pagination.php?page=1');
    }
            ...
            <div class="col-md-8 video-list">
                ...
                <div class="col-md-12" id="post-data">
                        <?php
                            ...
                            $sql = "SELECT * FROM videoList WHERE id < ". $curData ." ORDER BY id DESC LIMIT 12"; 
