...
$(document).ready(function() {
	...
	$.ajax({
		url: "/AdvancedWeb-AS4/api/queryPid.php?v=" + v,
		dataType: "json",
		async: false,
...
function load() {
	...
	$.ajax ({
		...
		// http://140.114.212.79/AdvancedWeb-AS4/src/pagination.php
		url: "http://140.114.212.79/AdvancedWeb-AS4/src/pagination.php",
		dataType: "json",
		success: function(data) {
			for (var i = 0; i < 5; i++) {
				//handleData(data, i);
...
// 	var img_url = "https://img.youtube.com/vi/" + data[id].vid + "/maxresdefault.jpg";
...
// 	var curPage = document.getElementsByClassName('active');
//         console.log(curPage[0].value);	
	
// 	if ($(window).scrollTop() + $(window).height() >= $(document).height()) {
// 		var last_id = $(".post-id:last").attr("id");
// 		if(last_id >  500 - curPage[0].value * 36)loadMoreData(last_id);
// 		console.log(last_id,'  in scroll',curPage,last_id);
// 	}
// });


// function loadMoreData(last_id) {
// 	console.log('load mre data');
// 	$.ajax(	{ 
// 			url: "/AdvancedWeb-AS4/src/loadMoreData.php?last_id=" + last_id,
// 			type: "GET",
// 			//dataType: "json",
// 			beforeSend: function () {
// 				console.log('in ajax');
