      ...
      <br>
        <div class="row">
          <div class="col-12 formText">
            <form action="../api/youtubeDL.php" method="get">
              <label for="urlYT"> Youtube Video Link </label>     
              <input id="inputURL" type="text" name="urlYT" value="" required="required" placeholder="Please enter youtube URL ">
              <button id='button' class="btn btn-outline-danger" type="submit" name="button"> ADD </button>
            </form>
          </div>
        </div>
        <br>
    ...
    <script>
        ...
        if(document.getElementById('inputURL').value != ""){
          document.getElementById("button").addEventListener("click", function(){
            document.getElementById("button").innerHTML = '<i class="fa fa-spinner fa-spin" style="font-size:18px"></i>&nbsp;正在取得外部資源';
          });
        }
