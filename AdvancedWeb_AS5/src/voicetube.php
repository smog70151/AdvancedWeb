<?php
    if(isset($_GET['page'])){
        $page = $_GET['page'];
        $data = file_get_contents('/AdvancedWeb-AS4/src/pagination.php?page='.$page);
    }else{
        $data = file_get_contents('/AdvancedWeb-AS4/src/pagination.php?page=1');
    }
...
<head>
    ...
    <!-- Index - VoiceTube CSS -->
    <link rel="stylesheet" href="/AdvancedWeb-AS4/src/styles/voicetube.css">
    <!-- Load Datas -->
    ...
    <!-- Load Scripts-->
    <script type="text/javascript" src="/AdvancedWeb-AS4/src/scripts/voicetube.js"></script>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="dropdown-toggle" href="#" id="white">匯入影片</a>
                    </li>
                    <li>
