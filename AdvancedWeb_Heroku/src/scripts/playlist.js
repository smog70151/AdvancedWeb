...
function load() {
	...
	$.ajax ({
		...
		error: function(jqXHR, textStatus, errorThrown) {
			alert("This playlist may contains unavailable videos");
		}
	})
}
...
function handleData(data, id) {
	...
	var img_url = "https://img.youtube.com/vi/" + data[id].videoID + "/hqdefault.jpg";
	...
	a.appendChild(img);
	a.setAttribute("href", '/AdvancedWeb-Heroku/api/youtubeDL.php?urlYT=https://www.youtube.com/watch?v='+ data[id].videoID + "%26list=" + playlistID);
	a.className = cnt;
