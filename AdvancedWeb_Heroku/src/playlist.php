...
<head>
    ...
    <!-- Index - VoiceTube CSS -->
    <link rel="stylesheet" href="/AdvancedWeb-Heroku/src/styles/playlist.css">
    <!-- Load Scripts-->
    <script type="text/javascript" src="/AdvancedWeb-Heroku/src/scripts/playlist.js"></script>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="dropdown-toggle" href="/AdvancedWeb-Heroku/src/formDL.php" id="white">匯入影片</a>
                    </li>
                    <li>
