...
<head>
    ...
    <link rel="stylesheet" href="https://140.114.212.79/AdvancedWeb-Heroku/src/styles/video.css">
...
<body>
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand" href="/AdvancedWeb-Heroku/src/formDL.php">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="/AdvancedWeb-Heroku/src/formDL.php">匯入影片</a>
                        <!-- <ul class="dropdown-menu">
    ...
    <div class="view-block">
            ...
            <div class="col-md-5 caption-block" id="right-caption">
                <div class="tags">
                    ...
                    <div class="pull-left right">
                        <button id="btnReplyWrong" type="button" class="btn btn-basic btn-xs">回報字幕錯誤</button>
                        <label class="switch">
                            <input type="checkbox">
        ...
        <div class="scrollmenu">
            <!-- <a href="#home"><img src="https://img.youtube.com/vi/zzXLMTngoBg/default.jpg"><div>sgsgsd</div></a> -->
        </div>
    ...
    <script type="text/javascript" src="/AdvancedWeb-Heroku/src/scripts/video.js"></script>
