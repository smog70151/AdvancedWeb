...
// 						console.log("pre time:" + fetch_min + ": " + fetch_sec);
// 						console.log("cur time:" + min + ": " + sec);
// 					if(fetch_min == min){
// 						if(fetch_sec > sec) {
...
// 	  console.log(t.value);
// 		if(t.value == "上傳字幕檔"){
// 		  //document.getElementById("uploadFile").setAttribute("required", "required");
// 		  //document.getElementById("upload").setAttribute("required", "required");
// 		  document.getElementById("uploadFile").required = true;
